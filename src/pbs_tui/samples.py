...
def sample_snapshot(now: datetime | None = None) -> SchedulerSnapshot:
    ...
    jobs = [
        Job(
            ...
            queue_time=now - timedelta(hours=2, minutes=10),
            start_time=now - timedelta(hours=2, minutes=5),
            eligible_duration=timedelta(minutes=5),
            eligible_start_time=now - timedelta(hours=2, minutes=10),
            walltime="04:00:00",
            nodes="2:ppn=128",
            estimated_start_time=now - timedelta(hours=2, minutes=5),
        ...
        Job(
            ...
            eligible_start_time=now - timedelta(minutes=30),
            walltime="01:00:00",
            nodes="1:ppn=64",
        ...
        Job(
            ...
            queue_time=now - timedelta(hours=1, minutes=20),
            walltime="00:30:00",
            nodes="1:ppn=32",
            estimated_start_time=now + timedelta(hours=2),
